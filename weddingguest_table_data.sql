...
INSERT INTO `guests` (`food_id`,`relationship_id`, `first_name`,`last_name`,`email`) values ( 1,1,'lucy','chong','lucy@gmail.com');
INSERT INTO `guests` (`food_id`,`relationship_id`, `first_name`,`last_name`,`email`) values ( 1,1,'mary','lim','mary@gmail.com');